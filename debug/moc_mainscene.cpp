...
QT_MOC_LITERAL(1, 10, 14), // "show_deathpage"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 15), // "close_mainscene"
QT_MOC_LITERAL(4, 42, 10), // "close_page"
QT_MOC_LITERAL(5, 53, 9) // "open_page"

    },
    "mainscene\0show_deathpage\0\0close_mainscene\0"
    "close_page\0open_page"
};
...
void mainscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->show_deathpage(); break;
        case 1: _t->close_mainscene(); break;
        case 2: _t->close_page(); break;
        case 3: _t->open_page(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mainscene::show_deathpage)) {
                *result = 0;
            }
        }
        {
            typedef void (mainscene::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&mainscene::close_mainscene)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 0
void mainscene::show_deathpage()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void mainscene::close_mainscene()
{
